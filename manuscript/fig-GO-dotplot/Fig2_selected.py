...
wb = xlrd.open_workbook("Fig2_David_selected.xlsx")
...
for s in range(4):
    ...
    for i in range(sheet.nrows):
        ...
        if fignum != sheet.cell_value(i, 0):
            ...
            fname = f"images/Fig2_selected/Fig2_{sheet_names[s]}_{fignum}.png"
        else:
            data.append([
...
GOplotFix(p[0], p[1].replace(".png", ".svg"), p[2], limits["Xmin"], limits["Xmax"],
          limits["Smin"], limits["Smax"], Plegend=True)
